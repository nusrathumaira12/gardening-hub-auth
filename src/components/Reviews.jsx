...
const Reviews = () => {
	...
	<div>
        ...
        <span onClick={(e) => alert(`Rated ${[...e.target.innerText].indexOf('⭐') + 1} stars`)}>⭐ ⭐ ⭐ ⭐ ⭐</span>
			...
			<blockquote className="max-w-lg text-lg  font-medium text-center">"Thanks to Miss Nusrat,I love how organized the events are — the upcoming events section makes planning my weekends so much easier."</blockquote>
